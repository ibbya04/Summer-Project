...
public class Node {
    ...
    // Adds an edge to this node's arraylist of edges, using the add keyword from ArrayList lib,
    // initiallising the new edge with constructor.
    public void addEdge(Node endNode) {
        this.edges.add(new Edge(this, endNode));
    }

    // Removes a node's edge by iterating through the node's edges until the edges endNode 
    // is equal to the endNode passed into function, then removes using remove func from library.
